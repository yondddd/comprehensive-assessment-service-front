...
const formRules: FormRules = reactive({
  ...
  name: [{ required: true, trigger: "blur", message: "请输入辅导员姓名" }]
})
const handleCreate = () => {
  ...
  <div class="app-container">
    <el-card v-loading="loading" shadow="never" class="search-wrapper">
      <el-form ref="searchFormRef" :inline="true" :model="searchData">
        <el-form-item prop="jobNumber" label="工号">
          <el-input v-model="searchData.jobNumber" placeholder="请输入工号" />
        </el-form-item>
        <el-form-item prop="name" label="姓名">
          <el-input v-model="searchData.name" placeholder="请输入辅导员姓名" />
        </el-form-item>
    ...
    <el-card v-loading="loading" shadow="never">
      <div class="toolbar-wrapper">
        <div>
          <el-button type="primary" :icon="CirclePlus" @click="dialogVisible = true">新增辅导员</el-button>
    ...
    <el-dialog
      ...
      :title="currentUpdateId === undefined ? '新增辅导员' : '修改辅导员'"
      @close="resetForm"
      width="30%"
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item prop="name" label="辅导员姓名">
